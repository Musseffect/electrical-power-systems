...
namespace ElectricalPowerSystems.Equations.DAE
{
    ...
    public class DAESemiImplicitDefinition : DAEDefinition
    {
        ...
        public DAESemiImplicitDefinition(string[] variableNamesX, string[] variableNamesZ, double[] initialValuesX, double[] initialValuesZ
            ...
            MathUtils.SparseMatrix<RPNExpression> dfdx, MathUtils.SparseMatrix<RPNExpression> dfddx,
            MathUtils.SparseMatrix<RPNExpression> dfdz, MathUtils.SparseMatrix<RPNExpression> dgdx, MathUtils.SparseMatrix<RPNExpression> dgdz)
        {
    ...
    public class DAEImplicitDefinition : DAEDefinition
    {
        ...
        public DAEImplicitDefinition(string[] variableNames, double[] initialValues, List<RPNExpression> f,
            MathUtils.SparseMatrix<RPNExpression> dfdx, MathUtils.SparseMatrix<RPNExpression> dfddx, double t0, double time)
        {
