    ...
    namespace ElementsAC
    {
        ...
        public class ResistorWithCurrent : Element2N
        {
            ...
            public override List<EquationBlock> GetParametersAC()
            {
                ...
                {
                    Equation = $"constant R_{elementIndex} = {resistance.ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
        ...
        public class ImpedanceWithCurrent : Element2N
        {
            ...
            public override List<EquationBlock> GetParametersAC()
            {
                ...
                equations.Add(new EquationBlock
                {
                    Equation = $"constant R_{elementIndex} = {impedance.Real.ToString(new CultureInfo("en-US"))};"
                });
                equations.Add(new EquationBlock
                {
                    Equation = $"constant X_{elementIndex} = {impedance.Imaginary.ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
            public override List<EquationBlock> GenerateEquationsAC()
        ...
        public class Impedance : Element2N
        {
            ...
            public override List<EquationBlock> GetParametersAC()
            {
                ...
                equations.Add(new EquationBlock
                {
                    Equation = $"constant G_{elementIndex} = {Y.Real.ToString(new CultureInfo("en-US"))};"
                });
                equations.Add(new EquationBlock
                {
                    Equation = $"constant B_{elementIndex} = {Y.Imaginary.ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
            public override List<EquationBlock> GenerateEquationsAC()
        ...
        public class Resistor : Element2N
        {
            ...
            public override List<EquationBlock> GetParametersAC()
            {
                ...
                equations.Add(new EquationBlock
                {
                    Equation = $"constant G_{elementIndex} = {(1.0/resistance).ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
            public override List<EquationBlock> GenerateEquationsAC()
        ...
        public class Transformer3w : Element6N
        {
            ...
            public override List<EquationBlock> GetParametersAC()
            {
                ...
                equations.Add(new EquationBlock
                {
                    Equation = $"constant k_{elementIndex}_1 = {b1.ToString(new CultureInfo("en-US"))};"
                });
                equations.Add(new EquationBlock
                {
                    Equation = $"constant k_{elementIndex}_1 = {b2.ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
        ...
        public class Transformer2w : Element4N
        {
            ...
            public override List<EquationBlock> GetParametersAC()
            {
                ...
                equations.Add(new EquationBlock
                {
                    Equation = $"constant k_{elementIndex} = {b.ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
            public override string ToString()
        ...
        public class Capacitor : Element2N
        {
            ...
            public override List<EquationBlock> GetParametersAC()
            {
                ...
                equations.Add(new EquationBlock
                {
                    Equation = $"constant C_{elementIndex} = {capacity.ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
            public override string ToString()
        ...
        public class Inductor : Element2N
        {
            ...
            public override List<EquationBlock> GetParametersAC()
            {
                ...
                equations.Add(new EquationBlock
                {
                    Equation = $"constant L_{elementIndex} = {inductivity.ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
            public override string ToString()
        ...
        public class VoltageSource : Element2N
        {
            ...
            public override string ToString()
            {
                return $"Voltage Source{{n1 = {nodes[0]}, n2 = {nodes[1]}, voltage = {voltage}@{MathUtils.MathUtils.Degrees(phase)}, frequency = {frequency} Hz}}";
            }
            public override List<EquationBlock> GenerateEquationsAC()
            {
                List<EquationBlock> equations = new List<EquationBlock>();
            ...
            public override List<EquationBlock> GetParametersAC()
            {
                ...
                equations.Add(new EquationBlock
                {
                    Equation = $"constant E_{elementIndex}_re = {(voltage * Math.Cos(phase)).ToString(new CultureInfo("en-US"))};"
                });
                equations.Add(new EquationBlock
                {
                    Equation = $"constant E_{elementIndex}_im = {(voltage * Math.Sin(phase)).ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
            public override Complex32 GetCurrent(NonlinearSystemSolution acSolution, float frequency)
            ...
            public override List<EquationBlock> GetParametersTransient()
            {
                ...
                equations.Add(new EquationBlock
                {
                    Equation = $"constant E_{elementIndex} = {(voltage).ToString(new CultureInfo("en-US"))};"
                });
                equations.Add(new EquationBlock
                {
                    Equation = $"constant w_{elementIndex} = {frequency.ToString(new CultureInfo("en-US"))};"
                });
                equations.Add(new EquationBlock
                {
                    Equation = $"constant ph_{elementIndex} = {phase.ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
        }
        public class Switch : Element2N
        {
            ...
            public override List<EquationBlock> GetParametersAC()
            {
                ...
                equations.Add(new EquationBlock
                {
                    Equation = $"constant switch_state_{elementIndex} = {(state ? 1.0 : 0.0).ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
        ...
        public class CurrentSource : Element2N
        {
            ...
            public override string ToString()
            {
                return $"Current Source{{n1 = {nodes[0]}, n2 = {nodes[1]}, current = {current}@{MathUtils.MathUtils.Degrees(phase)}, frequency = {frequency} Hz}}";
            }
            public override List<EquationBlock> GenerateEquationsAC()
            {
                List<EquationBlock> equations = new List<EquationBlock>();
            ...
            public override List<EquationBlock> GetParametersAC()
            {
                ...
                equations.Add(new EquationBlock
                {
                    Equation = $"constant J_{elementIndex}_re = {(current*Math.Cos(phase)).ToString(new CultureInfo("en-US"))};"
                });
                equations.Add(new EquationBlock
                {
                    Equation = $"constant J_{elementIndex}_im = {(current * Math.Sin(phase)).ToString(new CultureInfo("en-US"))};"
                });
                return equations;
            }
            public override Complex32 GetCurrent(NonlinearSystemSolution acSolution, float frequency)
            ...
            public override List<EquationBlock> GetParametersTransient()
            {
                ...
                new EquationBlock
                {
                    Equation = $"constant J_{elementIndex} = {current.ToString(new CultureInfo("en-US"))};"
                },
                new EquationBlock
                {
                    Equation = $"constant w_{elementIndex} = {frequency.ToString(new CultureInfo("en-US"))};"
