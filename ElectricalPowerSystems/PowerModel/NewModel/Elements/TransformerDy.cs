...
{
    class TransformerDy:Element,ISteadyStateElement,ITransientElement
    {
        enum Group
        {
            Dy1 = 0,
        ...
        List<EquationBlock> ISteadyStateElement.GenerateEquations()
        {
            ...
            {
                Equation = $"I_{ID}p1_re",
                Node1 = $"{in_p_1}_re",
                Node2 = $"{out_p_1}_re"
            });
            equations.Add(new CurrentFlowBlock
            {
                Equation = $"I_{ID}p1_im",
                Node1 = $"{in_p_1}_im",
                Node2 = $"{out_p_1}_im"
            });
            equations.Add(new CurrentFlowBlock
            {
                Equation = $"I_{ID}p2_re",
                Node1 = $"{in_p_2}_re",
                Node2 = $"{out_p_2}_re"
            });
            equations.Add(new CurrentFlowBlock
            {
                Equation = $"I_{ID}p2_im",
                Node1 = $"{in_p_2}_im",
                Node2 = $"{out_p_2}_im"
            });
            equations.Add(new CurrentFlowBlock
            {
                Equation = $"I_{ID}p3_re",
                Node1 = $"{in_p_3}_re",
                Node2 = $"{out_p_3}_re"
            });
            equations.Add(new CurrentFlowBlock
            {
                Equation = $"I_{ID}p3_im",
                Node1 = $"{in_p_3}_im",
                Node2 = $"{out_p_3}_im"
            });
            equations.Add(new CurrentFlowBlock
            {
                Equation = $"I_{ID}s1_re",
                Node1 = $"{in_s_1}_re",
                Node2 = $"{out_s_1}_re"
            });
            equations.Add(new CurrentFlowBlock
            {
                Equation = $"I_{ID}s1_im",
                Node1 = $"{in_s_1}_im",
                Node2 = $"{out_s_1}_im"
            });
            equations.Add(new CurrentFlowBlock
            {
                Equation = $"I_{ID}s2_re",
                Node1 = $"{in_s_2}_re",
                Node2 = $"{out_s_2}_re"
            });
            equations.Add(new CurrentFlowBlock
            {
                Equation = $"I_{ID}s2_im",
                Node1 = $"{in_s_2}_im",
                Node2 = $"{out_s_2}_im"
            });
            equations.Add(new CurrentFlowBlock
            {
                Equation = $"I_{ID}s3_re",
                Node1 = $"{in_s_3}_re",
                Node2 = $"{out_s_3}_re"
            });
            equations.Add(new CurrentFlowBlock
            {
                Equation = $"I_{ID}s3_im",
                Node1 = $"{in_s_3}_im",
                Node2 = $"{out_s_3}_im"
            });*/
            for (int i = 1; i < 4; i++)
    ...
    public class SteadyStateTransformerDyModel : ISteadyStateElementModel
    {
