    ...
    public class ASTInterpreter
    {
        ...
        static public class FunctionStorage
        {
            ...
            static public Object voltageSource2(List<Object> args)
            {
                ...
                int index = model.AddVoltageSource(arg1.Value, arg2.Value, (float)arg3.Value, (float)MathUtils.MathUtils.Radians(arg4.Value), (float)arg5.Value);
                return new Element(index);
            }
            ...
            static public Object currentSource2(List<Object> args)
            {
                ...
                Float arg4 = (Float)args[3];
                Float arg5 = (Float)args[4];
                int index = model.AddCurrentSource(arg1.Value, arg2.Value, (float)arg3.Value, (float)MathUtils.MathUtils.Radians(arg4.Value), (float)arg5.Value);
                return new Element(index);
            }
            ...
            static public Object radians(List<Object> args)
            {
                ...
                arg1.Value = MathUtils.MathUtils.Radians(arg1.Value);
                return arg1;
            }
            static public Object degrees(List<Object> args)
            {
                Float arg1 = (Float)args[0];
                arg1.Value = MathUtils.MathUtils.Degrees(arg1.Value);
                return arg1;
            }
        ...
        public class Complex : Object
        {
            ...
            public override String CastToString()
            {
                return new String(Magn.ToString()+"@"+ MathUtils.MathUtils.Degrees(Phase).ToString());
            }
        }
