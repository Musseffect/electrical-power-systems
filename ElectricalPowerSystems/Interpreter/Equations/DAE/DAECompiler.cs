...
namespace ElectricalPowerSystems.Interpreter.Equations.DAE
{
    ...
    public partial class DAECompiler
    {
        ...
        private DAEImplicitDefinition CompileDAEImplicit(RootNode root)
        {
            ...
            SparseMatrix<RPNExpression> dfdx = SparseMatrix<RPNExpression>.Build(equations.Count,equations.Count);
            SparseMatrix<RPNExpression> dfddx = SparseMatrix<RPNExpression>.Build(equations.Count, equations.Count);
